    ...
    function preview(e) {
        if (e.files[0]) {
            ...
            reader.onload = function(e) {
                document.querySelector('#gallery-display').setAttrivute('src', e.target.result);
            }
        ...
        <div class="my-auto">
            ...
            <form action="includes/gallery-helper.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <img src="images/signinBackground.jpg" alt="profile pic" onclick="triggered();" id="prof-display">

                    <input type="text" name="title" class="form-control" placeholder="title">
                    <input type="file" name="gellery-image" id="gallery-image" onchange="preview(this)" class="form-control" style="display: none;">
                </div>
                <div class="form-group">
